"""Sasi Mandava: echo_server.py 01/15/2017."""
...
def server(log_buffer=sys.stderr):
    ...
    sock = socket.socket(
                         ...
                         socket.SOCK_STREAM,
                         socket.IPPROTO_TCP)
    # TODO:_COMPLETE You may find that if you repeatedly run the server script it fails,
    ...
    # TODO_COMPLETE: bind your new sock 'sock' to the address above and begin to listen
    ...
    try:
        ...
        # TODO_COMPLETE: Use the python KeyboardInterrupt exception as a signal to
